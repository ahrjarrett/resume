...
export type ThemeCycle = typeof ThemeCycle[keyof typeof ThemeCycle]
...
const ThemeProvider: React.FC<React.PropsWithChildren> = ({ children }) => {
  const [theme, setTheme] = React.useState<ThemeCycle>(ThemeCycle.leuven)
  const handleSetTheme: React.EventHandler<React.MouseEvent> = (e) => {
    e.preventDefault
    setTheme((theme) => ThemeCycle[theme])
  }
